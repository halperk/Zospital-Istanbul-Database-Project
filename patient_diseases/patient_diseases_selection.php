...
<body>
    ...
    <div class="inner-page-top" style="margin-bottom: 3em;"><a><b>~ Patient Disease Filtering ~</b></a></br></div>
    <div><form action="select_patient_diseases.php" method="POST">
        <div class= "inputI"><a>Select a Patient to Get His/Her Diseases:</a></div>
